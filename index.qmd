...
Principal component analysis is a method of analyzing a data set by reducing a large number of variables into a smaller number of principal components. Principal component analysis will reduce the dimensionality of the data set, and make the model much simpler.
